...
class LightningLSTM(L.LightningModule):
    ...
    def __init__(self): # __init__() is the class constructor function, and we use it to initialize the Weights and Biases.
        ...
        self.lstm2 = nn.LSTM(input_size=5, hidden_size=1) 
    ...
    def forward(self, input):
        ...
        lstm_out, temp = self.lstm2(lstm_out)
    ...
    def configure_optimizers(self): # this configures the optimizer we want to use for backpropagation.
        return Adam(self.parameters(), lr=0.05) ## we'll just go ahead and set the learning rate to 0.1
...
print("\nNow let's compare the observed and predicted values...")
print("Company A: Observed = 0, Predicted =", model(torch.tensor([0., 0.5, 0.25, 1.])).detach())
print("Company B: Observed = 0.4, Predicted =", model(torch.tensor([1., 0.5, 0.25, 1.])).detach())
